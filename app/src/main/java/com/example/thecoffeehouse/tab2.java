...
public class tab2 extends Fragment {
    ...
    public void recycle_list(){
        ...
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_10));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_11));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.coffee_1));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.coffee_2));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.coffee_2));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.coffee_1));
        ...
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_7));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_9));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_10));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_11));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_10));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000 đ",R.drawable.product_10));
